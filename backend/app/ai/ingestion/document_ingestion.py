...
async def index_document(
    ...
    try:
        ...
        # Step 3: Prepare payloads and upsert to FAISS
        ...
        faiss_svc.delete_by_document_id(document_id)
        ...
        # Upsert
        success = faiss_svc.upsert_chunks(upsert_payloads)
        if not success:
            raise RuntimeError("Failed to upsert chunks into FAISS.")
