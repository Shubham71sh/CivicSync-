    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-5 py-2.5 rounded-lg bg-accent text-[#0a0a0f] text-sm font-bold hover:bg-accentHover transition-colors shadow-glow-accent whitespace-nowrap active:scale-95">
            New Analysis
          </button>
        </div>
      </div>
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="show" className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <motion.div variants={itemVariants} className="p-5 rounded-2xl bg-[#171a21] border border-border relative overflow-hidden hover:border-white/10 transition-colors">
          ...
          <h3 className="text-3xl font-bold text-white mb-3">1,284</h3>
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <motion.div 
                    ...
                    style={{ backgroundColor: eli15Mode ? "#0a0a0f" : "#0a0a0f" }}
                    initial={false}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-2xl bg-[#171a21] border border-border flex gap-4 items-start group hover:border-white/10 transition-colors cursor-pointer">
                <div className="w-10 h-10 rounded-xl bg-danger/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <ShieldAlert className="w-5 h-5 text-danger" />
                </div>
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <h4 className="font-bold text-white text-sm">Anomalous Contract Detected</h4>
                    <span className="text-xs text-textSecondary">2 mins ago</span>
                  </div>
                  <p className="text-sm text-textSecondary">Unusual bidding pattern found in Metro Project Phase 4. Estimated discrepancy: $1.2M.</p>
                </div>
              </div>
              
              <div className="p-4 rounded-2xl bg-[#171a21] border border-border flex gap-4 items-start group hover:border-white/10 transition-colors cursor-pointer">
                <div className="w-10 h-10 rounded-xl bg-success/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <FileText className="w-5 h-5 text-success" />
                </div>
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <h4 className="font-bold text-white text-sm">New Environmental Bill (r-401)</h4>
                    <span className="text-xs text-textSecondary">1 hour ago</span>
                  </div>
                  <p className="text-sm text-textSecondary">CivicSync AI identifies 3 clauses that may impact your current tax bracket.</p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-[#171a21] border border-border flex gap-4 items-start group hover:border-white/10 transition-colors cursor-pointer">
                ...
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <h4 className="font-bold text-white text-sm">Community Milestone Reached</h4>
                    <span className="text-xs text-textSecondary">4 hours ago</span>
                  </div>
                  <p className="text-sm text-textSecondary">Transparency petition for public parks has reached 10,000 verified signatures.</p>
                </div>
              </div>
            </div>
          </div>
