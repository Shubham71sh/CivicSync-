      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-[#0B0B12]/90 backdrop-blur-md border-b border-[rgba(255,255,255,0.06)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 shrink-0">
            {/* Hamburger button for screens below desktop (< lg) */}
            <button
              onClick={() => setMobileSidebarOpen(!mobileSidebarOpen)}
              className="lg:hidden p-2 -ml-2 rounded-lg text-[#A5A8B5] hover:text-white hover:bg-white/5 transition-colors focus:outline-none focus:ring-2 focus:ring-[#F4C95D]"
        ...
        {mobileSidebarOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 z-55 w-64 bg-[#0d0f14] shadow-2xl border-r border-[rgba(255,255,255,0.08)] lg:hidden flex flex-col"
            >
              {/* Drawer Top Header with Close (X) button */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-[rgba(255,255,255,0.08)] bg-[#0d0f14]">
